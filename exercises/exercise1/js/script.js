...
// The image of the background in purple.
var purpleBackdropImage;
...
function preload() {
  ...
  purpleBackdropImage = loadImage("assets/images/purple_backdrop.png");
}
...
function setup() {
  ...
  // Display the purple background image.
  image(purpleBackdropImage, 0, 0, width, height);
